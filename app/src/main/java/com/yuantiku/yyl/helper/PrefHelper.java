...
public class PrefHelper {
    ...
    public PrefHelper put(String key, String value) {
        getPref().edit().putString(key, value).commit();
        return this;
    }

    public PrefHelper put(String key, int value) {
        getPref().edit().putInt(key, value).commit();
        return this;
    }

    public PrefHelper put(String key, boolean value) {
        getPref().edit().putBoolean(key, value).commit();
        return this;
    }

    public PrefHelper put(String key, float value) {
        getPref().edit().putFloat(key, value).commit();
        return this;
    }

    public PrefHelper put(String key, long value) {
